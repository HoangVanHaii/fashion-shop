...
onMounted(async () => {
    ...
    await useFlashSale.getFlashSaleHotDeal1NotIN(excludeIds);
    flashSale1.value = useFlashSale.hotDeal1;
    ...
    await useFlashSale.getFlashSaleHotDeal2NotIN(excludeIds);
    flashSale2.value = useFlashSale.hotDeal2
    ...
    <div class="container-deals">
        <div class="deal-item" v-if="flashSale1">
            ...
            <div class="deal-content">
                ...
                <div class="deal-product">
                    <div v-for="product in displayedProductHotDeal1" class="deal-item-product">
                        <div class="deal-image">
                            <div class="container-percent" v-if="getDiscountPercent(product.min_price, product.flash_price) > 0" >
                                <span class="text-percent">{{ getDiscountPercent(product.min_price, product.flash_price) }}%</span>
                            ...
                            <div class="deal-info">
                                ...
                                <div class="deal-bottom">
                                    <div class="deal-prices">
                                        <span class="deal-price-new" >{{ formatPrice(product.flash_price!) }}</span>
                                        <span class="deal-price-old">{{ formatPrice(product.max_price) }}</span>
                                    </div>
        ...
        <div class="deal-item" v-if="flashSale2">
            ...
            <div class="deal-content deal2">
                ...
                <div class="deal-product">
                    <div v-for="product in displayedProductHotDeal2" class="deal-item-product">
                        <div class="deal-image">
                            <div class="container-percent" v-if="getDiscountPercent(product.min_price, product.flash_price) > 0" >
                                <span class="text-percent">{{ getDiscountPercent(product.min_price, product.flash_price) }}%</span>
                            </div>
...
@media (max-width: 1200px){
    ...
    .deal-info .deal-name p, .deal-prices span{
        font-size: 14px;
    }
