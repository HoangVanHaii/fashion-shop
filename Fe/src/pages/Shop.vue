...
onMounted(async () => {
    ...
    vouchers.value = await useVoucher.getAllVoucherStore();
    distributeProducts();
})
...
const formatIsoToDate = (dateInput: string | Date | null | undefined): string => {
...
<template>
    ...
    <div class="container">
        <div class="top-content">
            ...
            <div class="right-content">
                <div class="content">
                    ...
                    <span><i class="fa-regular fa-star"></i>Đánh giá: {{ shop?.rating || 0 }}</span>
                </div>
                <div class="content">
                    <span><i class="fa-solid fa-users"></i>Lượt truy cập: {{ shop?.visit_count }}</span>
                    <span><i class="fa-solid fa-user-check"></i>Tham gia: {{ formatIsoToDate(shop?.created_at!) }}</span>
                </div>
        ...
        <div class="bottom-content">
            <div class="deal-hot">
                <span class="title-deal"><i class="fa-solid fa-fire"></i> Ưu đãi khủng</span>
                <div class="btn-deal">
                    <button @click="distanceContent(-100)"><i class="fa-solid fa-arrow-left"></i></button>
                    <button @click="distanceContent(100)"><i class="fa-solid fa-arrow-right"></i></button>
                </div>
                <div class="deal-product" :class="showAllDeal ? 'yes' : 'no'" ref="dealContent">
                    <div
